...
| `reached <t> C during this acquisition` | The camera ran hot. Check its airflow and mount before the next recording. This line is listed here only when the recording lost frames; otherwise it appears in the status bar and the log. |
